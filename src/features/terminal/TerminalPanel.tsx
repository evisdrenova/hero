...
export const TerminalPanel = forwardRef<TerminalPanelHandle, TerminalPanelProps>(
  function TerminalPanel({ height, tab, workspace, onWorkspaceChange, onToggle, handleResizeStart }, ref) {
    ...
    return (
      ...
      >
            ...
            {workspace.terminalTabs.map((terminalTab) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1.5 text-[12px] border-b-2 transition-colors ${isActive
        ...
        <div className="min-w-0 flex-1 overflow-hidden">
          {activeTerminalTab ? (
            <div
              className={`flex h-full ${activeTerminalTab.splitDirection === "horizontal"
                ? "flex-col"
                : "flex-row"
                }`}
            >
              {activeTerminalTab.panes.map((pane) => {
                ...
                return (
                  <div
                    ...
                    className={`flex min-h-0 min-w-0 flex-1 flex-col border-border-subtle ${activeTerminalTab.panes.length > 1
